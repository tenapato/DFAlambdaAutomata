...
def checkTransition(string, matrix, estado, puede):
    ...
    if string:
        ...
        print("Estados finales: " + str(estado))
        if any (x in estado for x in Automata.finalState):
            print("El string es valido")
        else:
            print("El string no es valido")
